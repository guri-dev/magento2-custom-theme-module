...
use Pilot\Smile\Api\Data\OptionsInterface;
use Pilot\Smile\Helper\Options as OptionsHelper;
 ...
 * @since 100.0.2
 */
class Options extends AbstractModel implements OptionsInterface, IdentityInterface
{
    /**
     * No route page id
     */
    ...
    {
        $this->_init(\Pilot\Smile\Model\ResourceModel\Options::class);
    }
    ...
    {
        return $this->hasData('stores') ? $this->getData('stores') : (array)$this->getData('options_id');
    }
