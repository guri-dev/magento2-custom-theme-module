...
use Pilot\Smile\Api\Data\BannerInterface;
use Pilot\Smile\Helper\Banner as BannerHelper;
...
class Banner extends AbstractModel implements BannerInterface, IdentityInterface
{
    ...
    {
        $this->_init(\Pilot\Smile\Model\ResourceModel\Banner::class);
    }
    ...
    {
        return $this->hasData('stores') ? $this->getData('stores') : (array)$this->getData('banner_id');
    }
